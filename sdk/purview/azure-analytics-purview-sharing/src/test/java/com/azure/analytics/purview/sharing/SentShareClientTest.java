...
class SentShareClientTest extends PurviewShareTestBase {
    ...
    void getSentShareTest() {
       ...
       SentShare retrievedSentShare = super.sentSharesClient
               .getSentShareWithResponse(sentShareId.toString(), new RequestOptions())
               .getValue()
    ...
    void getAllSentSharesTest() {
       ...
       PagedIterable<BinaryData> sentShares = super.sentSharesClient
           .getAllSentShares(
                   super.providerStorageAccountResourceId,
                   new RequestOptions());
       
       assertTrue(sentShares.stream().findAny().isPresent());
       assertTrue(sentShares
                   .stream()
    ...
    void createSentShareServiceInvitation() {
        ...
        Response<BinaryData> invitationResponse = super.createSentShareAndServiceInvitation(sentShareId, sentShareInvitationId);
    ...
    void getSentShareServiceInvitation() {
        ...
        Response<BinaryData> invitationResponse =
                super.sentSharesClient.getSentShareInvitationWithResponse(sentShareId.toString(), sentShareInvitationId.toString(), new RequestOptions());
    ...
    void getAllSentShareServiceInvitations() {
        ...
        PagedIterable<BinaryData> invitations =
                super.sentSharesClient.getAllSentShareInvitations(sentShareId.toString(), new RequestOptions());
    ...
    void deleteSentShareServiceInvitation() {
        ...
        SyncPoller<BinaryData,Void> syncPoller =
                super.sentSharesClient.beginDeleteSentShareInvitation(sentShareId.toString(), sentShareInvitationId.toString(), new RequestOptions());
